...
var MultiSelectItem = function (_SingleSelectItem) {
  _inherits(MultiSelectItem, _SingleSelectItem);
  ...
  _createClass(MultiSelectItem, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.isSelected() ? React.createElement(CheckBoxIcon, { style: { pointerEvents: 'none' } }) : React.createElement(CheckBoxOutlineBlank, { style: { pointerEvents: 'none' } }),
        React.createElement(
          'span',
          null,
          itemData.name
